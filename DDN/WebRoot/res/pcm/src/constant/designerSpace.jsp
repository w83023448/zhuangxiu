...
<div class="chakanTop clearfix">
	<div class="cakeNav">
    	<a href="javascript:void(0)">案例库</a><span></span><a href="javascript:void(0)" class="nowYemian">设计师个人空间</a>
    </div>
    <a class="cakeNew" href="javascript:void(0)">
    新建
    </a>
</div>
...
<div class="chakanCnt clearfix">
    ...
    <div class="chakanCntBox02">
    	<h2 class="clearfix"><a href="javascript:void(0)" class="editIcon02"></a>张三</h2>
    ...
    <div class="chakanCntBox03">
        ...
        <DIV class="slide-pic-coco" id="slidePic-coco">
				...
				<DIV class="pic-container-coco">
					<UL>
					  <LI class="cur-coco">
					  <P><a class="date-coco">2012-12-21</a></P>
                      </LI>
					  <LI class="">
					  <P><a class="date-coco">2012-12-21</a></P>
                      </LI>
...
function selected03(obj)
{
	...
	$_('selectbottom03').style.display='none';
        ...
        <div class="payAddLine clearfix">
           ...
           <a class="btn-select" id="btn_select02"> 
                <div class="btn-select-div clearfix">
           ...
           <a class="btn-select" id="btn_select03" style="margin-bottom:0;"> 
                <div class="btn-select-div clearfix">
...
<div class="main_anli clearfix">
	<ul>
    	<li class="chakanCntBox03"><a href="javascript:void()"><img src="images/img01.jpg" />
    	  <p>3室2厅 20万 复古</p></a>
          <a href="javascript:void(0)" class="editIcon03">
        	<img src="images/edit.png"/>
          </a>
        </li>
      	<li class="chakanCntBox03"><a href="javascript:void()"><img src="images/img02.jpg" />
    	  <p>3室2厅 20万 复古</p></a>
          <a href="javascript:void(0)" class="editIcon03">
        	<img src="images/edit.png"/>
          </a>
        </li>
      	<li class="chakanCntBox03"><a href="javascript:void()"><img src="images/img03.jpg" />
    	  <p>3室2厅 20万 复古</p></a>
          <a href="javascript:void(0)" class="editIcon03">
        	<img src="images/edit.png"/>
          </a>
        ...
        <li class="chakanCntBox03 hideLi"><a href="javascript:void()"><img src="images/img01.jpg" />
    	  <p>3室2厅 20万 复古</p></a>
          <a href="javascript:void(0)" class="editIcon03">
        	<img src="images/edit.png"/>
          </a>
        </li>
      	<li class="chakanCntBox03 hideLi"><a href="javascript:void()"><img src="images/img02.jpg" />
    	  <p>3室2厅 20万 复古</p></a>
          <a href="javascript:void(0)" class="editIcon03">
        	<img src="images/edit.png"/>
          </a>
        </li>
      	<li class="chakanCntBox03 hideLi"><a href="javascript:void()"><img src="images/img03.jpg" />
    	  <p>3室2厅 20万 复古</p></a>
          <a href="javascript:void(0)" class="editIcon03">
        	<img src="images/edit.png"/>
          </a>
